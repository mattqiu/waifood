...
//jquery tap插件
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('(3($,4){\'z y\';h 7=\'x\'A B,2={b:7?\'w\':\'D\',c:7?\'C\':\'F\'};$.6[4]=3(6){r d[6?\'5\':\'s\'](4,6)};$.o.u[4]={v:3(){$(d).5(2.b+\' \'+2.c,3(e){2.E=7?e.H.M[0]:e}).5(2.b,3(e){n(e.p&&e.p!==1){r}2.8=e.8;2.l=j m().k();2.i=2.E.9;2.g=2.E.a}).5(2.c,3(e){n(2.8==e.8&&((j m().k()-2.l)<G)&&(2.i==2.E.9&&2.g==2.E.a)){h t=$(d);e.K=3(){t.5(\'I\',f)};e.J=4;e.9=2.E.9;e.a=2.E.a;$.o.s(4)}})},O:3(){$(d).q(2.b,f).q(2.c,f)}}})(N,\'L\');',51,51,'||ev|function|name|bind|fn|isTap|target|pageX|pageY|start|end|this||false|Y|var|X|new|getTime|time|Date|if|event|which|unbind|return|trigger||special|setup|touchstart|ontouchstart|strict|use|in|document|touchend|mousedown||mouseup|750|originalEvent|click|type|preventDefault|tap|changedTouches|jQuery|remove'.split('|'),0,{}));
