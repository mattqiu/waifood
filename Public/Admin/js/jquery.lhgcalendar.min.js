	...
	'<td>' +
	    '<div class="lcui_head">' +
			...
			'<tr>' +
				...
				'<td width="40"><input class="cui_im" maxlength="4" value=""/></td>' +
				'<td><a class="cui_nm" href="javascript:void(0);"></a></td>' +
				'<td width="14"><a class="cui_py" href="javascript:void(0);"></a></td>' +
				'<td width="60"><input class="cui_iy" maxlength="4" value=""/></td>' +
		...
		'<div class="cui_foot">' +
		    '<table width="100%" cellspacing="0" cellpadding="0" border="0">' +
			'<tr>' +
			    '<td align="center" class="lcui_today"><a class="cui_tbtn" href="javascript:void(0);">Today</a></td>' +
				...
				'<td align="center" class="lcui_empty"><a class="cui_dbtn" href="javascript:void(0);">Clear</a></td>' +
			'</tr>' +
			'</table>' +
		'</div>' +
	'</td>' +
...
lhgcalendar.fn = lhgcalendar.prototype =
{
	...
	_setCell: function( cell, num, enabled )
	{
		if( enabled )
		{
			...
			//遍历时计算当前日期：2012-08-26
			var m=('00'+this.month);
			var d=('00'+num);
			m = m.substring(m.length-2,m.length);
			d = d.substring(d.length-2,d.length);
			var dt=(this.year+"-"+ m+"-"+d);
			$.each(selectedDate,function(key,value){ 
				if(value==dt){
					$(cell).addClass('cui_selected');
				}
			}); 
...
$(function(){
	 ...
	 if($('.calendar2').length>0){
		$('.calendar2').calendar({maxDate:'%y-%M-%d',minDate:"1900-01-01" });
	} 
	 if($('.calendar3').length>0){
		$('.calendar3').calendar({minDate:'%y-%M-%d' });
	} 
});