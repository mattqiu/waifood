...
var point="<div class='point'></div>";
	$(".banner").append(point);		
	var num=$(".touchslider-viewport li").length;	
	for(var i=0;i<num;i++){
		$(".point").append("<a href='javascript:void(0)'></a>");
	}
	$(".point a").eq(0).addClass("current");
	$(".banner").touchSlider({
        container: this,
        duration: 350, // 动画速度
        delay: 3000, // 动画时间间隔
		...
		prev: ".arrow a#prev", // prev 样式指定
		next: ".arrow a#next", // next 样式指定		
		pagination: ".point a",
