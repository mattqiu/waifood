...
class WxPayConf_pub{
	...
	//const KEY = '33333dweixinpay101lingdian147258';
    public static $KEY = '';
	...
	const JS_API_CALL_URL = 'http://www.waifood.com/home/weixin/jsapicall';
	
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = '/home/www/waifood/Application/Common/Conf/pem/apiclient_cert.pem';
	const SSLKEY_PATH = '/home/www/waifood/Application/Common/Conf/pem/apiclient_key.pem';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	const NOTIFY_URL = 'http://www.waifood.com/home/weixin/weixinback';
	//=======【curl超时设置】===================================
	//本例程通过curl使用HTTP POST方法，此处可修改其超时时间，默认为30秒
	const CURL_TIMEOUT = 30;
   // const URL = 'http://www.waifood.com/home/weixin/';
