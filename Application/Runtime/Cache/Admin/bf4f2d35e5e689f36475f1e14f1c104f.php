...
<form action="/Admin/Cms/editOrder" method="post" name="form1"
  ...
  <table border="0" cellspacing="1" cellpadding="3" class="MainTbl">
    ...
    <tr class="row0">
      ...
      <td colspan="3"><input type="text" class="inputText1 readonly" readonly="readonly" name="orderno" id="orderno" value="<?php echo ($db["orderno"]); ?>" /> <?php if(($db["orderfrom"]) == "1"): ?><span class="fc_red">微信订单</span><?php else: ?>网站订单<?php endif; ?></td>
    </tr>
    <tr class="row0">
      <td class="col1">用户名：</td>
      <td colspan="3"><input type="text" class="inputText1" readonly="readonly" maxlength="100" value="<?php echo get_username($db['userid']);?>" />
    ...
    <tr class="row0">
      ...
      <td colspan="3"><select name="status" id="status" >
        ...
        </select>  <?php if(($db["status"] == 3) Or ($db["status"] == 4) ): else: ?>
             <input type="submit" class="btn1"
					value="保存" id="btnSubmit" /><?php endif; ?></td>
    </tr>
    ...
    <tr class="row0">
      ...
      <td><input type="text" class="inputText1 calendar1" readonly="readonly" name="paytime" id="paytime" maxlength="20" value="<?php echo ($db["paytime"]); ?>" /></td>
     
    </tr>
    <tr class="row0">
      <td class="col1">交易流水号：</td>
      <td><input type="text" class="inputText1" readonly="readonly" name="trade_no" id="trade_no" maxlength="50" value="<?php echo ($db["trade_no"]); ?>" /></td>
     
       <td class="col1">使用积分：</td>
      <td><input type="text" class="inputText1 w50" name="credit" id="credit" maxlength="50" value="<?php echo ($db["credit"]); ?>" readonly="readonly" />
    ...
    <tr class="row0">
      <td class="col1">(+) 运费：</td>
      <td><input type="text" class="inputText1 numeric w50"  name="shipfee" id="shipfee" maxlength="50" value="<?php echo ($db["shipfee"]); ?>" /></td>
     
       <td class="col1">(-) 折扣：</td>
      <td><input type="text" class="inputText1 numeric w50" name="discount" id="discount" maxlength="50" value="<?php echo ($db["discount"]); ?>"  /></td>
    
    </tr>
    <tr class="row0">
      <td class="col1">(-) 优惠券：</td>
      <td colspan="3"><input type="text" class="inputText1 numeric w50"  name="couponamount" id="couponamount" maxlength="50" value="<?php echo ($db["couponamount"]); ?>"  readonly="readonly" /></td>
      
    </tr>
    <tr class="row0">
      <td class="col1 "><span class="fc_red">应支付金额：</span></td>
      <td colspan="3"><input type="text numeric" class="inputText1 w50" id="needpay" name="needpay" value="<?php echo ($db["amount"]); ?>" /></td>
    ...
    <tr class="row0">
      ...
      <td colspan="3"><input type="text" class="inputText1 w350" name="delivertime" id="delivertime" value="<?php echo ($db["delivertime"]); ?>" /></td>
    </tr>
    <tr class="row0">
      <td class="col1">收货地址：</td>
      <td colspan="3"><input type="text" class="inputText1 w350" name="address" id="address"  value="<?php echo ($db["proname"]); echo ($db["cityname"]); echo ($db["disname"]); echo ($db["address"]); ?>" /> <?php if(!empty($db["remark"])): ?>Remarks: <?php echo ($db["remark"]); endif; ?></td>
    </tr>
    <tr class="row0">
      ...
      <td colspan="8" class="tc">商品列表</td>
          ...
          <tr align="center">
            ...
            <td><a href="javascript:void(0);" class="dplus dplus1 fl">-</a>
              <input type="text" class="inputText1 numeric w50 fl" value="<?php echo ($vo["num"]); ?>" onchange="$.EditOrder(1,'<?php echo ($vo["orderno"]); ?>','<?php echo ($vo["id"]); ?>',$(this).val())" stock="9999"/>
              <a href="javascript:void(0);"   class="dplus dplus2 fl">+</a></td>
            <td><?php echo to_price($sub);?></td>
            <td ><a href="javascript:void(0);" onclick="$.EditOrder(2,'<?php echo ($vo["orderno"]); ?>','<?php echo ($vo["id"]); ?>','1')">删除</a></td>
          </tr>
          <?php
