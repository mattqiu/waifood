...
<div class="container">
  <div class="content">
    <div class="box980">
      <div class="left">
        <div class="Ltit01 nyltit"><strong><?php echo ($fathername); ?></strong></div>
        <div class="txt01 hymenu">
          <?php if(is_array($channel)): $i = 0; $__LIST__ = $channel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Content/lists?id='.$vo['id']);?>"   
            <?php if(($pid) == $vo['id']): ?>class="selected"<?php endif; ?>
            ><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
      </div>
      <div class="right04">
        <?php if(($cateinfo["viewtype"]) == "1"): ?><div class="bzxtit"><?php echo ($db["title"]); ?></div>
          <div class="txt03"> <?php echo ($db["content"]); ?> </div>
          <?php else: ?>
          <div class="news_title"><?php echo ($db["title"]); ?></div>
          <div class="news_date">Date：<?php echo ($db["addtime"]); ?></div>
          <div class="txt03"> <?php echo ($db["content"]); ?> </div>
          <div class="txt03"> <span class="span5">Next: <?php echo ($next); ?></span> <br />
            <span class="span5">Prev: <?php echo ($prev); ?></span> </div><?php endif; ?>
      </div>
    </div>
    <div class="clear"></div>
  </div>
