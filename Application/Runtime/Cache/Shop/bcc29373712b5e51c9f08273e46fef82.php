          ...
          <form id="myform" method="post" onsubmit="return false;" >
            <table border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td><input type="text" class="reginput"  size="40" name="username" id="username"  placeholder="enter your user name" required="required" />
                ...
                <tr>
                    ...
                    <td><input  class="reginput" maxlength="32" size="40" type="password" name="userpwd" id="userpwd"  placeholder="4-20 characters" required="required" />
                        <span class="fc_red">*</span></td>
                </tr>
                <tr>
                    <td align="right">Confirm Password：</td>
                    <td><input  class="reginput" maxlength="32" size="40" type="password" name="userpwd1" id="userpwd1"  placeholder="repeat your password" required="required" />
                        <span class="fc_red">*</span></td>
                </tr>
                <tr>
                    <td align="right">Living city in China：</td>
                    <td>
              ...
              <tr>
                ...
                <td>
                    <input type="text" class="reginput fl" size="24"  maxlength="5" name="verify" id="verify"  placeholder="enter captcha" required="required" />                       <img style="cursor:pointer;margin-left:5px; cursor: hand; width:100px; height:36px; float:left;" title="click to reload captcha" alt="" onclick="this.src='/index/verify.html?random='+Math.random()" src="/index/verify.html?v=<?php echo rand(0,999);?>" />
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
