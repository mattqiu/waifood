...
<div class="container">
  <div class="content">
    <div class="error">
      <div class="bzxtit">Prompt information</div>
      <div class="txt03">
        <?php if(isset($message)): ?><div style="text-align:center;"><img src="/Public/Shop/images/cg.gif" width="90" height="90"  alt="" /></div>
          <div class="error_title msg_success">:) <?php echo($message); ?></div>
          <?php else: ?>
          <div style="text-align:center;"><img src="/Public/Shop/images/error.png" alt="" /></div>
          <div class="error_title msg_error">:( <?php echo($error); ?></div><?php endif; ?>
        <div style="text-align:center;">
          <p class="jump"> <a id="href" href="<?php echo($jumpUrl); ?>">Page automatically redirect</a> Waiting： <b id="wait"><?php echo($waitSecond); ?></b> </p>
        </div>
        <div style="text-align:center; padding:20px 0"><a href="javascript:void(0);" onclick="history.back()" class="jixu">Go back</a></div>
      </div>
    </div>
  </div>
  <div class="clr"></div>
