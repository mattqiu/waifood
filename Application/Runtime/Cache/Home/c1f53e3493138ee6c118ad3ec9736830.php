...
<div class="container pdt5"> 
  <div class="saixuan">
  <ul>
      <li><a href="<?php echo Uu('Search/index','keyword='.$keyword.'&order=1');?>"  
        <?php if(($order) == "1"): ?>class="selected"<?php endif; ?>
        >Default</a></li>
     <li>
       <?php if(($order) == "2"): ?><a href="<?php echo Uu('Search/index','keyword='.$keyword.'&order=2&sort='.$so);?>"   
      ...
      <?php else: ?>
      <a href="<?php echo Uu('Search/index','keyword='.$keyword.'&order=2&sort='.$so);?>"  ><span class="">Price</span></a><?php endif; ?>
    </li>
      <li>
      <?php if(($order) == "3"): ?><a href="<?php echo Uu('Search/index','keyword='.$keyword.'&order=3&sort='.$so);?>"   
      ...
      <?php else: ?>
      <a href="<?php echo Uu('Search/index','keyword='.$keyword.'&order=3&sort='.$so);?>"  ><span class="">Sold</span></a><?php endif; ?>
  ...
  <div class="splist">
    <ul>
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
          <div class="box"> <a href="<?php echo Uu('Product/view','id='.$vo['id']);?>"> <img  src="/Public/Shop/images/grey.gif" class="lazy"  data-original="<?php echo ($vo["indexpic"]); ?>" alt="<?php echo ($vo["title"]); ?>"   width="100%" /> <strong  ><?php echo str_ireplace($keyword,'<font class="fc_red">'.$keyword.'</font>',$vo['title']);?></strong><br> 
