$(function(){  
    ...
    $.sendMail = function() {
		...
		if(email==""){ 
            jAlert("Sorry, email cannot be empty.",SYSTITLE,function(){$("#emaillist").focus();}); 
			return false;
		}
        ...
        $.ajax({
            ...
            success: function(msg) {
                var o = eval(msg);
                if (o.status == "1") {
                	jAlert('succeed.',SYSTITLE,function(){$("#emaillist").val("");});
	...
	if(username==""){ 
            jAlert("Sorry, username cannot be empty.",SYSTITLE,function(){$("#username").focus();});
			
			return false;	  
	}
	
	if(pwd==""){ 
            jAlert("Sorry, password cannot be empty.",SYSTITLE,function(){$("#password").focus();});
			return false;	  
	}
