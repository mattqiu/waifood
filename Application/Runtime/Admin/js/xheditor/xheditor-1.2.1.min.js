...
var default_setting,default_editor;
$(function(){
	var upload_url="";
		upload_url=CONST_UPLOAD.replace('upload.html','upload_editor.html');
	 default_setting={upLinkUrl:''+upload_url+'?immediate=1',upImgUrl:'!{editorRoot}xheditor_plugins/multiupload/multiupload.html?uploadurl='+upload_url+'%3Fimmediate%3D1&ext=图片文件(*.jpg;*.jpeg;*.gif;*.png)',upFlashUrl:'!{editorRoot}xheditor_plugins/multiupload/multiupload.html?uploadurl='+upload_url+'%3Fimmediate%3D1&ext=Flash动画(*.swf)',upMediaUrl:'!{editorRoot}xheditor_plugins/multiupload/multiupload.html?uploadurl='+upload_url+'%3Fimmediate%3D1&ext=多媒体文件(*.wmv;*.avi;*.wma;*.mp3;*.mid)',html5Upload:false,localUrlTest:/^http?:\/\/[^\/]*?(abcd\.com)\//i,remoteImgSaveUrl:upload_url+'?saveremoteimage=1'};
		default_editor=$(".editor").xheditor(default_setting);	 
});