...
class OrderController extends BaseController
{
    ...
    public function addPointOrder($item_id = 0, $num = 1, $ext = null)
    {
        ...
        $data = M('content')->field('id,stock,price')
            ->where($where)
            ->find();
    ...
    protected function createOrder($shop_id = 0)
    {
        if (IS_POST) {
            ...
            if ($db['cart_num'] > 0) {
                ...
                if ($address) {
                    if (isN($address['username'])) {
                        $address['username'] = get_username(get_userid());
                    }
    ...
    public function testmail(){
        $orderno='201502112219321644';
        $body = lbl('tpl_createorder');
        $mailhtml = $this->mailhtml($orderno, 1);
        
        $body .= $mailhtml;
        we(send_mail('77826787@qq.com', 'test', $body)) ;
    }
    ...
    private function mailhtml($orderno = '', $admin = '')
    {
        ...
        if ($data) {
            ...
            if ($isShop) {
                ...
                // }
                $html .= "  <tr>\n";
                $html .= "    <td colspan=\"6\"  > Product list</td> \n";
                $html .= "  </tr> \n";
                $html .= "  <tr>\n";
            ...
            if ($isService) {
                ...
                // $html.= "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" >\n";
                $html .= "  <tr>\n";
                $html .= "    <td colspan=\"6\"  > Laundry Service  list</td> \n";
                $html .= "  </tr> \n";
